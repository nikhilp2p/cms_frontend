...
@Component({
  selector: 'app-add-managecharger',
  standalone: true,
  imports: [
        MatDialogModule,
        MatFormFieldModule,
  ...
  templateUrl: './add-managecharger.component.html',
  styleUrl: './add-managecharger.component.scss'
})
export class AddManagechargerComponent {

    chargerForm: FormGroup;
  
    constructor(
      private fb: FormBuilder,
      private dialogRef: MatDialogRef<AddManagechargerComponent>,
    ...
    ngOnInit(): void {
      if (this.data?.mode === 'edit' && this.data?.connector) {
        this.chargerForm.patchValue(this.data.connector);
      }
    }
